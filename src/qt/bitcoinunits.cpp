...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("BNS");
    case mBTC: return QString("mBNS");
    case uBTC: return QString("uBNS");
...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString("Bonus (1 : 1)");
    case mBTC: return QString("miliBonus (1 / 1,000)");
    case uBTC: return QString("microBonus (1 / 1,000,000)");
    //case nBTC: return QString("nanoBonus (1 / 1,000,000,000)"); //Don't support nano BNS yet.
    default: return QString("???");
    }
}
