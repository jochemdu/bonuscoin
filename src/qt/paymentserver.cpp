...
const QString BITCOIN_IPC_PREFIX("bonus:");
...
{
    // Install global event filter to catch QFileOpenEvents on the mac (sent when you click bonus: links)
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start bonus: click-to-pay handler");
    else
...
{
    // clicking on bonus: URLs creates FileOpen events on the Mac:
